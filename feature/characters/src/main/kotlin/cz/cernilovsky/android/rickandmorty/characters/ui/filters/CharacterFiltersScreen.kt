package cz.cernilovsky.android.rickandmorty.characters.ui.filters
    ...
    Scaffold(
                ...
                actions = {
                    IconButton(onClick = actions.onApply) {
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.button_apply),
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text(text = stringResource(R.string.filter_name_label)) },
                singleLine = true,
            ...
            OutlinedTextField(
                ...
                label = { Text(text = stringResource(R.string.filter_species_label)) },
                singleLine = true,
                modifier = Modifier.fillMaxWidth(),
            )
            OutlinedTextField(
                ...
                label = { Text(text = stringResource(R.string.filter_type_label)) },
                singleLine = true,
                modifier = Modifier.fillMaxWidth(),
            )
            FilterSection(
            ...
            FilterSection(
                title = stringResource(R.string.filter_gender_label),
