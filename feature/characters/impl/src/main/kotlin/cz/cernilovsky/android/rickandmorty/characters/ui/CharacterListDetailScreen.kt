...
import cz.cernilovsky.android.rickandmorty.characters.ui.detail.CharacterDetailScreen
import cz.cernilovsky.android.rickandmorty.characters.ui.detail.IMAGE_HEIGHT
import cz.cernilovsky.android.rickandmorty.characters.ui.list.CharacterListActions
import cz.cernilovsky.android.rickandmorty.characters.ui.list.CharacterListScreen
import cz.cernilovsky.android.rickandmorty.characters.ui.list.UiCharacter
import cz.cernilovsky.android.rickandmorty.core.ui.LocalSharedTransitionContext
import cz.cernilovsky.android.rickandmorty.core.ui.SharedTransitionContext
 ...
 * [NavigableListDetailPaneScaffold]. The scaffold owns the single- vs two-pane decision *and* the
 * predictive-back gesture (wired to the navigator internally), so `App` mounts this on every window
 * size and no longer folds a separate detail route in and out at the breakpoint:
 *
