...
import cz.cernilovsky.android.rickandmorty.characters.domain.model.CharacterFilterField
...
import cz.cernilovsky.android.rickandmorty.core.ui.toMessageRes
                ...
                actions = {
                    IconButton(onClick = actions.onFilterClick) {
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.button_filters),
                        )
                    }
                },
                colors =
...
fun ActiveFiltersRow(
    ...
    FlowRow(
        ...
        filters.name?.let {
            FilterInputChip(stringResource(R.string.filter_label_name, it)) {
                onRemoveFilter(CharacterFilterField.Name)
            }
        }
        filters.species?.let {
            FilterInputChip(stringResource(R.string.filter_label_species, it)) {
                onRemoveFilter(CharacterFilterField.Species)
            }
        }
        filters.type?.let {
            FilterInputChip(stringResource(R.string.filter_label_type, it)) {
        ...
        TextButton(onClick = onClearFilters) {
            Text(text = stringResource(R.string.button_clear_all))
        }
    }
}
...
fun EmptyFilteredMessage() {
    Box(
        ...
        Text(
            text = stringResource(R.string.empty_no_characters_match),
    ...
    Surface(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = character.name,
                    // headlineSmallEmphasized isn't part of this Compose BOM's public Typography
                    // surface (unlike the CMP material3 build this app ported from); headlineSmall
